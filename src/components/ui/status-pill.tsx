...
export function StatusPill({ status }: { status: ArtworkStatus }) {
  return (
    <span
      className={cn(
        "inline-flex items-center gap-2 rounded-full border px-3.5 py-1.5 text-[0.62rem] font-medium uppercase tracking-[0.28em] shadow-[inset_0_1px_0_rgba(255,255,255,0.55)]",
